...
const activeProducts = await productService.findAll({
  orderBy: { updatedAt: 'desc' }, // [!code focus]
  limit: 20 // [!code focus]
})
...
<Cards>
  <Card href="/docs/queries/api-reference" title="Query API Reference">
    Complete API documentation for all query operations.
  </Card>
  <Card href="/docs/mutations/api-reference" title="Mutation API Reference">
    Detailed documentation for create, update, and delete operations.
  </Card>
  <Card href="/docs/bulk-operations/api-reference" title="Bulk Operations API Reference">
    API reference for high-performance bulk operations.
  </Card>
</Cards>
