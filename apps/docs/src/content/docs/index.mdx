...
<Callout
  title="Configure TypeScript for Drizzle Service"
  type="warning"
>
To ensure optimal performance and compatibility, configure your TypeScript project with the following settings:
</Callout>
