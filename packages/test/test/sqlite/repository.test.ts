...
describe('SQLITE Repository: Mutation Operations', () => {
...
describe('SQLITE Repository: Bulk Mutation Operations', () => {
...
describe('SQLITE Repository: Query Operations (Without Options)', () => {
...
describe('SQLITE Repository: Query Operations (With Options)', () => {
	...
	it('should find records using custom filtering logic with SQL expressions', async () => {
		...
		// Use a timestamp that's guaranteed to match our test data (1 hour ago)
